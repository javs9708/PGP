        ...
        if 'bc3' in request.POST:
            ...
            if not error:
                ...
                if not sonIguales:
                    ...
                    if presupuesto:
                        presupuesto = Presupuesto.objects.get(nombre=cuenta_fuente)
                        monto=int(monto)
                        presupuesto.monto=int(presupuesto.monto)
                        presupuesto.tipo_divisa=str(presupuesto.tipo_divisa)
                        presupuesto.monto-=monto
                        if presupuesto.monto<0:
                            error2=True
                            mensaje_cuenta = (True,"No puede realizar la acción, fondos insuficientes")
                            ...
                            if tarjetaD:
                                ...
                                tarjetaD.saldo_inicial=int(tarjetaD.saldo_inicial)
                                tarjetaD.tipo_divisa=str(tarjetaD.tipo_divisa)
                                if presupuesto.tipo_divisa=="EUR" and tarjetaD.tipo_divisa=="COP":
                                    monto=monto*3358
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="DOL" and tarjetaD.tipo_divisa=="COP":
                                    monto=monto*2851
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="YEN" and tarjetaD.tipo_divisa=="COP":
                                    monto=monto*26
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="COP" and tarjetaD.tipo_divisa=="COP":
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and tarjetaD.tipo_divisa=="DOL":
                                    monto=monto*1.17
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="DOL" and tarjetaD.tipo_divisa=="DOL":
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="YEN" and tarjetaD.tipo_divisa=="DOL":
                                    monto=monto*0.0090
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="COP" and tarjetaD.tipo_divisa=="DOL":
                                    monto=monto*0.00035
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and tarjetaD.tipo_divisa=="EUR":
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="DOL" and tarjetaD.tipo_divisa=="EUR":
                                    monto=monto*0.854
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="YEN" and tarjetaD.tipo_divisa=="EUR":
                                    monto=monto*0.007
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="COP" and tarjetaD.tipo_divisa=="EUR":
                                    monto=monto*0.00030
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and tarjetaD.tipo_divisa=="YEN":
                                    monto=monto*128.68
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="DOL" and tarjetaD.tipo_divisa=="YEN":
                                    monto=monto*110.01
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="YEN" and tarjetaD.tipo_divisa=="YEN":
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                                if presupuesto.tipo_divisa=="COP" and tarjetaD.tipo_divisa=="YEN":
                                    monto=monto*0.038
                                    tarjetaD.saldo_inicial+=monto
                                    tarjetaD.save()
                            ...
                            if prestamoD:
                                ...
                                prestamoD.monto=int(prestamoD.monto)
                                prestamoD.tipo_divisa=str(prestamoD.tipo_divisa)
                                if presupuesto.tipo_divisa=="EUR" and prestamoD.tipo_divisa=="COP":
                                    monto=monto*3358
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="DOL" and prestamoD.tipo_divisa=="COP":
                                    monto=monto*2851
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="YEN" and prestamoD.tipo_divisa=="COP":
                                    monto=monto*26
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="COP" and prestamoD.tipo_divisa=="COP":
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and prestamoD.tipo_divisa=="DOL":
                                    monto=monto*1.17
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="DOL" and prestamoD.tipo_divisa=="DOL":
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="YEN" and prestamoD.tipo_divisa=="DOL":
                                    monto=monto*0.0090
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="COP" and prestamoD.tipo_divisa=="DOL":
                                    monto=monto*0.00035
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and prestamoD.tipo_divisa=="EUR":
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="DOL" and prestamoD.tipo_divisa=="EUR":
                                    monto=monto*0.854
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="YEN" and prestamoD.tipo_divisa=="EUR":
                                    monto=monto*0.007
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="COP" and prestamoD.tipo_divisa=="EUR":
                                    monto=monto*0.00030
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and prestamoD.tipo_divisa=="YEN":
                                    monto=monto*128.68
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="DOL" and prestamoD.tipo_divisa=="YEN":
                                    monto=monto*110.01
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="YEN" and prestamoD.tipo_divisa=="YEN":
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                                if presupuesto.tipo_divisa=="COP" and prestamoD.tipo_divisa=="YEN":
                                    monto=monto*0.038
                                    prestamoD.monto+=monto
                                    prestamoD.save()
                            ...
                            if inversionD:
                                ...
                                inversionD.monto=int(inversionD.monto)
                                inversionD.tipo_divisa=str(inversionD.tipo_divisa)
                                if presupuesto.tipo_divisa=="EUR" and inversionD.tipo_divisa=="COP":
                                    monto=monto*3358
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="DOL" and inversionD.tipo_divisa=="COP":
                                    monto=monto*2851
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="YEN" and inversionD.tipo_divisa=="COP":
                                    monto=monto*26
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="COP" and inversionD.tipo_divisa=="COP":
                                    inversionD.monto+=monto
                                    inversionD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and inversionD.tipo_divisa=="DOL":
                                    monto=monto*1.17
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="DOL" and inversionD.tipo_divisa=="DOL":
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="YEN" and inversionD.tipo_divisa=="DOL":
                                    monto=monto*0.0090
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="COP" and inversionD.tipo_divisa=="DOL":
                                    monto=monto*0.00035
                                    inversionD.monto+=monto
                                    inversionD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and inversionD.tipo_divisa=="EUR":
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="DOL" and inversionD.tipo_divisa=="EUR":
                                    monto=monto*0.854
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="YEN" and inversionD.tipo_divisa=="EUR":
                                    monto=monto*0.007
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="COP" and inversionD.tipo_divisa=="EUR":
                                    monto=monto*0.00030
                                    inversionD.monto+=monto
                                    inversionD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and inversionD.tipo_divisa=="YEN":
                                    monto=monto*128.68
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="DOL" and inversionD.tipo_divisa=="YEN":
                                    monto=monto*110.01
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="YEN" and inversionD.tipo_divisa=="YEN":
                                    inversionD.monto+=monto
                                    inversionD.save()
                                if presupuesto.tipo_divisa=="COP" and inversionD.tipo_divisa=="YEN":
                                    monto=monto*0.038
                                    inversionD.monto+=monto
                                    inversionD.save()
                            ...
                            if chequeraD:
                                ...
                                chequeraD.monto=int(chequeraD.monto)
                                chequeraD.tipo_divisa=str(chequeraD.tipo_divisa)
                                if presupuesto.tipo_divisa=="EUR" and chequeraD.tipo_divisa=="COP":
                                    monto=monto*3358
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="DOL" and chequeraD.tipo_divisa=="COP":
                                    monto=monto*2851
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="YEN" and chequeraD.tipo_divisa=="COP":
                                    monto=monto*26
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="COP" and chequeraD.tipo_divisa=="COP":
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and chequeraD.tipo_divisa=="DOL":
                                    monto=monto*1.17
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="DOL" and chequeraD.tipo_divisa=="DOL":
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="YEN" and chequeraD.tipo_divisa=="DOL":
                                    monto=monto*0.0090
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="COP" and chequeraD.tipo_divisa=="DOL":
                                    monto=monto*0.00035
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and chequeraD.tipo_divisa=="EUR":
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="DOL" and chequeraD.tipo_divisa=="EUR":
                                    monto=monto*0.854
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="YEN" and chequeraD.tipo_divisa=="EUR":
                                    monto=monto*0.007
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="COP" and chequeraD.tipo_divisa=="EUR":
                                    monto=monto*0.00030
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                #----------------------------------------------------#
                                if presupuesto.tipo_divisa=="EUR" and chequeraD.tipo_divisa=="YEN":
                                    monto=monto*128.68
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="DOL" and chequeraD.tipo_divisa=="YEN":
                                    monto=monto*110.01
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="YEN" and chequeraD.tipo_divisa=="YEN":
                                    chequeraD.monto+=monto
                                    chequeraD.save()
                                if presupuesto.tipo_divisa=="COP" and chequeraD.tipo_divisa=="YEN":
                                    monto=monto*0.038
                                    chequeraD.monto+=monto
                                    chequeraD.save()
